...
<div class="row">
    <div class="col-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/whole_hemisphere/sampling.png" title="MRI-guided histology sampling" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
