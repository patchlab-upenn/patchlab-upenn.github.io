    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_quantitative/";
            },},{id: "projects-whole-hemisphere-postmortem-imaging-in-adrd",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/4_whole_hemisphere/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/patch-lab-upenn-752967375", "_blank");
        },
      },{
        id: 'social-scholar',
